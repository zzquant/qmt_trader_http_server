...
def trade_allin():
    ...
    try:
        ...
        return jsonify({'error': f'全仓买入接口异常: {str(e)}'}), 500
...
def nhg():
    ...
    try:
        ...
        return jsonify({'error': f'逆回购接口异常: {str(e)}'}), 500
...
def cancel_all_orders_sale():
    ...
    try:
        ...
        return jsonify({'error': f'取消所有卖单接口异常: {str(e)}'}), 500
...
def cancel_all_orders_buy():
    ...
    try:
        ...
        return jsonify({'error': f'取消所有买单接口异常: {str(e)}'}), 500
...
def order():
    ...
    try:
        ...
        return jsonify({'error': f'订单查询接口异常: {str(e)}'}), 500
...
def orders():
    ...
    try:
        ...
        return jsonify({'error': f'所有订单查询接口异常: {str(e)}'}), 500
